...
import org.machairodus.manager.component.impl.MonitorTpsComponentImpl;
...
@Component
@ImplementedBy(MonitorTpsComponentImpl.class)
@RequestMapping("/monitor/tps")
public interface MonitorTpsComponent {

	@RequestMapping("/init")
	Object init(@RequestParam(name = "monitorType") String monitorType, Model model);
}
