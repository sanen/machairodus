...
import org.machairodus.topology.quartz.defaults.JmxMonitor.MemoryUsage;
...
public class LocalJmxMonitorQuartz extends BaseQuartz {
	...
	public static final long JMX_RATE = Long.parseLong(System.getProperty("context.quartz.app.jmx.rate", "1000"));
